...
urlpatterns = [
    ...
    path("transactions/<str:year>/<str:month>/<str:date>/", TransactionListDate.as_view(), name="transactions_month_year"),
    ...
    path("details/month/<int:month>/", DetailsViewMonth.as_view(), name="details"),
    path("details/year/<int:year>/", DetailsViewYear.as_view(), name="details"),
    path("details/<int:year>/<int:month>/", DetailsViewYearMonth.as_view(), name="details"),
